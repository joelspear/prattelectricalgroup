...
const data = suburbLandingPages["adelaide-cbd"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: `https://www.prattelectricalgroup.com/electrician-adelaide-cbd`,
  },
  twitter: {
...
export default function ElectricianAdelaideCbdPage() {
